...
class Sonido {
    ...
    agregarCola(comando, mensaje) {
        ...
        return new Promise( async (success, failure) => {
            ...
            success('Ahora te digo ese IARL');
        });
        ...
        if(!sonando) {
            ...
            if(sonido !== undefined) {
                ...
                if (voiceChannel) {
                    ...
                    voiceChannel.join()
                        .then((conexion) => {
                            const dispatcher = conexion.play('./lobizon/' + sonido.comando + '.mp3');
                        ...
                        .catch( (err) => {
                            ...
                            return failure("No pude reproducir esa lengue, fijate los permisos del chanel HEIST")
                        });
